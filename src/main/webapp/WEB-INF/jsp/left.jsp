		...
		<table width="200" height="100%" border="0" cellpadding="0" cellspacing="0" class="left_nav_bg">
		  ...
		  <tr valign="top">
		    <td class="left_nav_bgshw" height="50">
			  <p class="left_nav_link">&nbsp;&nbsp;<a href="user/selectUser" target="main">用户查询</a></p>
			  <p class="left_nav_link">&nbsp;&nbsp;<a href="user/addUser?flag=1" target="main">添加用户</a></p>
			</td>
		  </tr>
		  ...
		  <tr valign="top" id="submenu1" style="display: none">
		    <td class="left_nav_bgshw" height="50">
			  <p class="left_nav_link">&nbsp;&nbsp;<a href="dept/selectDept" target="main">部门查询</a></p>
			  <p class="left_nav_link">&nbsp;&nbsp;<a href="dept/addDept?flag=1" target="main">添加部门</a></p>
			</td>
		  </tr>
		  <tr><td height="2"></td></tr>
		  ...
		  <tr valign="top" id="submenu2" style="display: none">
		    <td class="left_nav_bgshw" height="50">
			  <p class="left_nav_link">&nbsp;&nbsp;<a href="job/selectJob" target="main">职位查询</a></p>
			  <p class="left_nav_link">&nbsp;&nbsp;<a href="job/addJob?flag=1" target="main">添加职位</a></p>
			</td>
		  </tr>
		  <tr><td height="2"></td></tr>
		  ...
		  <tr valign="top" id="submenu3" style="display: none">
		    <td class="left_nav_bgshw" height="50">
			  <p class="left_nav_link">&nbsp;&nbsp;<a href="${ctx }/employee/selectEmployee" target="main">员工查询</a></p>
			  <p class="left_nav_link">&nbsp;&nbsp;<a href="${ctx }/employee/addEmployee?flag=1" target="main">添加员工</a></p>
			</td>
		  </tr>
		  <tr><td height="2"></td></tr>
		  ...
		  <tr valign="top" id="submenu4" style="display: none">
		    <td class="left_nav_bgshw tdbtmline" height="50">
			  <p class="left_nav_link">&nbsp;&nbsp;<a href="${ctx }/notice/selectNotice" target="main">公告查询</a></p>
			  <p class="left_nav_link">&nbsp;&nbsp;<a href="${ctx }/notice/addNotice?flag=1" target="main">添加公告</a></p>
			</td>
		  </tr>
		  <tr><td height="2"></td></tr>
		  ...
		  <tr valign="top" id="submenu5" style="display: none">
		    <td class="left_nav_bgshw tdbtmline" height="50">
		    	<p class="left_nav_link">&nbsp;&nbsp;<a href="${ctx }/document/selectDocument" target="main">文档查询</a></p>
			  	<p class="left_nav_link">&nbsp;&nbsp;<a href="${ctx }/document/addDocument?flag=1" target="main">上传文档</a></p>
			</td>
		  </tr>
		  <tr><td height="2"></td></tr>
		 
		  <%--<tr valign="top"><td height="100%" align="center"><div class="copycct"><br /><strong>技术支持：</strong><br><strong>大学生启航开发公司</strong><br>Http://www.dreamyy.top:8080</div></td></tr>--%>
